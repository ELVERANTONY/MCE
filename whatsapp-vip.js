...
const VIP_TEMPLATES = [
  () =>
    [
      ...
      VIP_LINK,
      '',
      '🎁 Al llegar a los *600 miembros* realizaremos un sorteo exclusivo.',
      '',
      '¡Te esperamos!',
    ].join('\n'),
  () =>
    [
      ...
      VIP_LINK,
      '',
      '🎁 Además, al llegar a los *600 integrantes* realizaremos un *SORTEO EXCLUSIVO* entre todos los miembros.',
      '',
  ...
  () =>
    [
      ...
      VIP_LINK,
      '',
      '🎁 Recuerda que al llegar a los *600 integrantes* realizaremos un sorteo especial entre todos los miembros del grupo.',
    ].join('\n'),
  () =>
    [
      ...
      VIP_LINK,
      '',
      '🎁 Muy pronto realizaremos un sorteo exclusivo al llegar a los 600 miembros.',
    ].join('\n'),
  () =>
    [
      ...
      VIP_LINK,
      '',
      '🎁 *Sorteo exclusivo* al completar los 600 integrantes del grupo.',
    ].join('\n'),
  () =>
    [
      '💎 *ACCESO VIP - MERCADO CENTRAL EXPRESS* 💎',
      '',
      'Queremos premiar tu preferencia invitándote a nuestro grupo cerrado.',
      '',
      'Aquí descubrirás:',
      '🛍️ *Precios rebajados*',
      '🛍️ *Adelantos de mercadería*',
      '🛍️ *Promociones únicas*',
      '',
      'Haz clic aquí para entrar 👇',
      VIP_LINK,
      '',
      '🎁 ¡Habrá un gran sorteo cuando lleguemos a 600 miembros!',
    ].join('\n'),
  () =>
    [
      '⭐ *CLIENTE PREFERENCIAL DE MERCADO CENTRAL EXPRESS* ⭐',
      '',
      '¿Te gustaría enterarte de nuestras ofertas antes que los demás?',
      '',
      'Únete al grupo VIP y accede a:',
      '⚡ *Remates relámpago*',
      '⚡ *Catálogo exclusivo*',
      ...
      VIP_LINK,
      '',
      '🎁 Atención: ¡Sorteo especial confirmado al alcanzar los 600 participantes!',
    ].join('\n'),
  () =>
    [
      '🔔 *¡AVISO IMPORTANTE - MERCADO CENTRAL EXPRESS!* 🔔',
      '',
      'Acabamos de abrir un grupo exclusivo para nuestros mejores clientes.',
      '',
      'Te ofrecemos:',
      '👉 *Ofertas de locura*',
      '👉 *Novedades semanales*',
      ...
      VIP_LINK,
      '',
      '🎁 ¡No te pierdas nuestro sorteo al ser 600 integrantes!',
    ].join('\n'),
  () =>
    [
      '🥇 *COMUNIDAD VIP - MERCADO CENTRAL EXPRESS* 🥇',
      '',
      'Forma parte de nuestro círculo más selecto de compradores.',
      '',
      'Disfruta de ventajas como:',
      '✅ *Precios especiales solo para el grupo*',
      '✅ *Stock limitado de novedades*',
      '✅ *Descuentos sorpresa*',
      '',
      'Te esperamos adentro 👇',
      VIP_LINK,
      '',
      '🎁 Participa del sorteo exclusivo cuando seamos 600 en el grupo.',
    ].join('\n'),
  () =>
    [
      '🌟 *¡ERES INVITADO ESPECIAL A NUESTRO GRUPO VIP!* 🌟',
      '',
      'MERCADO CENTRAL EXPRESS te abre las puertas a sus mejores promociones.',
      '',
      ...
      VIP_LINK,
      '',
      '🎁 ¡Se viene un gran premio sorteado al llegar a 600 personas!',
    ].join('\n'),
  () =>
    [
      '🛍️ *OFERTAS SECRETAS - MERCADO CENTRAL EXPRESS* 🛍️',
      '',
      'Tenemos un grupo privado de WhatsApp donde publicamos nuestras mejores gangas.',
      '',
      '¿Qué ganas al unirte?',
      '✔️ *Descuentos por tiempo limitado*',
      '✔️ *Acceso anticipado a productos*',
      '✔️ *Precios VIP*',
      '',
      'Entra al grupo ahora mismo 👇',
      VIP_LINK,
      '',
      '🎁 ¡Falta muy poco para los 600 miembros y lanzar el gran sorteo!',
    ].join('\n'),
  () =>
    [
      '🎟️ *PASE EXCLUSIVO AL GRUPO VIP* 🎟️',
      '',
      'Hola, MERCADO CENTRAL EXPRESS quiere recompensar tu fidelidad.',
      '',
      'Acompáñanos en el grupo donde hay:',
      ...
      VIP_LINK,
      '',
      '🎁 ¡Y prepárate para el sorteo cuando el grupo alcance los 600 usuarios!',
    ].join('\n'),
  () =>
    [
      '💥 *OFERTAS VIP - MERCADO CENTRAL EXPRESS* 💥',
      '',
      'No dejes pasar la oportunidad de estar en nuestro grupo de élite.',
      '',
      'Allí publicamos todos los días:',
      '🚀 *Nuevos ingresos a precio rebajado*',
      ...
      VIP_LINK,
      '',
      '🎁 ¡Sortearemos un premio exclusivo al llegar a 600 integrantes!',
    ].join('\n'),
  () =>
    [
      '🎁 *REGALOS Y OFERTAS - MERCADO CENTRAL EXPRESS* 🎁',
      '',
      'Estamos invitando a clientes seleccionados a unirse a nuestra comunidad VIP.',
      '',
      'Benefíciate de:',
      ...
      VIP_LINK,
      '',
      '🎁 ¡No olvides que habrá un súper sorteo al juntar 600 miembros!',
    ].join('\n'),
  () =>
    [
      '👑 *CLUB DE CLIENTES - MERCADO CENTRAL EXPRESS* 👑',
      '',
      'Bienvenido a la comunidad donde el ahorro es real y exclusivo.',
      '',
      'En este grupo tendrás acceso a:',
      '✅ *Promociones escondidas*',
      ...
      VIP_LINK,
      '',
      '🎁 Participa en el súper sorteo de celebración por los 600 integrantes.',
    ].join('\n'),
  () =>
    [
      '✨ *EXCLUSIVO PARA TI - MERCADO CENTRAL EXPRESS* ✨',
      '',
      'Sabemos que te encantan las buenas ofertas, por eso te invitamos a nuestro grupo privado.',
      '',
      'Aquí encontrarás:',
      '🛍️ *Liquidaciones VIP*',
      '🛍️ *Descuentos especiales*',
      '🛍️ *Adelantos exclusivos*',
      '',
      'Haz clic y únete ya 👇',
      VIP_LINK,
      '',
      '🎁 ¡A punto de llegar a 600 miembros para activar el gran sorteo!',
    ].join('\n'),
  () =>
    [
      '💎 *COMUNIDAD EXCLUSIVA DE COMPRAS* 💎',
      '',
      'MERCADO CENTRAL EXPRESS te da la bienvenida a su grupo VIP de WhatsApp.',
      '',
      '¿Qué te espera adentro?',
      '⚡ *Precios que no verás en otro lado*',
      '⚡ *Descuentos de locura*',
      '⚡ *Prioridad en productos nuevos*',
      '',
      'Accede a los beneficios 👇',
      VIP_LINK,
      '',
      '🎁 ¡Sorteo especial en camino al sumar 600 personas al grupo!',
    ].join('\n'),
  () =>
    [
      '⭐ *MERCADO CENTRAL EXPRESS - CLIENTES DESTACADOS* ⭐',
      '',
      'Queremos tenerte en nuestro grupo más exclusivo, con los mejores precios del mercado.',
      '',
      'Disfruta de:',
      '👉 *Beneficios VIP*',
      '👉 *Promociones exclusivas de WhatsApp*',
      '👉 *Descuentos de primera mano*',
      '',
      'Únete con un solo clic 👇',
      VIP_LINK,
      '',
      '🎁 ¡Un sorteo increíble nos espera al alcanzar los 600 miembros!',
    ].join('\n'),
  () =>
    [
      '🚀 *AHORRA MÁS CON MERCADO CENTRAL EXPRESS* 🚀',
      '',
      'Si quieres comprar a precio de socio, este es tu lugar ideal.',
      '',
      'En nuestro grupo VIP lanzamos:',
      '🔥 *Ofertas bomba*',
      '🔥 *Artículos recién importados*',
      '🔥 *Descuentos para miembros*',
      '',
      'Entra al chat VIP 👇',
      VIP_LINK,
      '',
      '🎁 ¡No te pierdas el gran sorteo cuando lleguemos a los 600 participantes!',
    ].join('\n'),
  () =>
    [
      '🎉 *ÚNETE AL CÍRCULO VIP DE MERCADO CENTRAL EXPRESS* 🎉',
      '',
      'Para nuestros mejores clientes, hemos creado un grupo con descuentos irrepetibles.',
      '',
      'Mira todo lo que compartimos:',
      '✅ *Precios especiales en todo*',
      '✅ *Stock limitado VIP*',
      '✅ *Ofertas diarias*',
      '',
      ...
      VIP_LINK,
      '',
      '🎁 ¡El gran sorteo se realizará cuando seamos 600 en el grupo!',
    ].join('\n'),
];
