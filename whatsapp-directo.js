...
const WA_EMOJI = {
  ...
  tired: String.fromCodePoint(0x1f629),
  down: String.fromCodePoint(0x1f447),
  luggage: String.fromCodePoint(0x1f9f3),
...
const WHATSAPP_MESSAGE = [
  `${WA_EMOJI.fire} ¡AHORRA ESPACIO HASTA UN 75% EN TU HOGAR! ${WA_EMOJI.fire}`,
  '',
  `¿Tu ropero está lleno y sin espacio? ${WA_EMOJI.tired}`,
  `¡Tenemos la solución perfecta para ti! ${WA_EMOJI.down}`,
  '',
  `${WA_EMOJI.luggage} Bolsas al vacío de alta calidad`,
  `${WA_EMOJI.shirt} Protege tu ropa del polvo, humedad y malos olores`,
  `${WA_EMOJI.box} Más espacio en segundos`,
  `${WA_EMOJI.rocket} Envío rápido + stock inmediato`,
  '',
  `${WA_EMOJI.boom} PROMO DESTACADA:`,
  '✔ Pack desde S/79',
  '✔ Bolsas desde S/30',
  '✔ Opciones x3, x6 y x12',
  '',
  `${WA_EMOJI.warning} Oferta limitada - ¡aprovecha antes que se acaben!`,
  '',
  `${WA_EMOJI.point} Mira todo el catálogo aquí:`,
  'https://elverantony.github.io/mercadocentralexpress/#/catalogo',
  '',
  `${WA_EMOJI.phone} Haz tu pedido fácil por WhatsApp`,
  '',
  `${WA_EMOJI.bulb} *Más espacio, menos volumen* - Mercado Central Express.`,
].join('\n');
